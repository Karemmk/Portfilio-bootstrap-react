...
function NavBar() {
  ...
  return (
    <div id="navbar" className="mb-5 pb-5">
      ...
      <DropdownMenu className={darkMode? "bg-secondary border border-warning":"bg-light border border-warning"}>
        <DropdownItem className="border-bottom border-warning" onClick={traChk?  ((e)=>handleClick(e)):((e)=>e.preventDefault(e)) } >{traChk? 'Anglais':'English'}</DropdownItem>
